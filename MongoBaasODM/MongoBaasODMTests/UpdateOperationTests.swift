...
class UpdateOperationTests: XCTestCase {
    ...
    func testUpdateOperations(types: [UpdateOperationType]) {
        ...
        let updateOperation = UpdateOperation(criteria: .exists(field: UpdateOperationTests.fieldKey, value: true), mongoClient: mongoClient)
        
        mongoClient.database.collection.expectedInputBlock = { (queryDocument, updateDocument) in
            for type in types {
        ...
        updateOperation.execute(operations: types, collection: mongoClient.database.collection)
    ...
    func testUpdateOperationPullMultiple() {
        ...
        updateOperation.execute(operations: [type], collection: mongoClient.database.collection)
