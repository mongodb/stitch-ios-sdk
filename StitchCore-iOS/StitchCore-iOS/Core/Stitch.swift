...
public class Stitch {
    ...
    public static func initialize() throws {
        try! StitchCore.sync(self) {
            ...
            if let appVersion = Bundle.main.infoDictionary?[kCFBundleVersionKey as String] as? String  {
                ...
                print("WARNING: Failed to get version of application, will not be sent to MongoDB Stitch in device info.")
            }
     ...
     *
     * - returns: A StitchAppClient with the configuration specified when `initializeDefaultAppClient(:withConfigBuilder)` was called.
     * - throws: A `StitchInitializationError` if `initialize()` was never called, or if `initializeDefaultAppClient` was never called.
     */
     ...
     */
    public static func initializeDefaultAppClient(withConfigBuilder configBuilder: StitchAppClientConfigurationBuilder) throws -> StitchAppClient {
        return try! StitchCore.sync(self) {
            guard initialized else {
                throw StitchInitializationError.stitchNotInitialized
            }
     ...
     */
    public static func initializeAppClient(withConfigBuilder configBuilder: StitchAppClientConfigurationBuilder) throws -> StitchAppClient {
        return try! StitchCore.sync(self) {
            guard initialized else {
                throw StitchInitializationError.stitchNotInitialized
            }
