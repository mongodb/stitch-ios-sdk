...
/**
 * A utility class which contains a property that can be used with `StitchAuth` to retrieve an `AnonymousAuthProviderClient`.
 */
public final class AnonymousAuthProvider {
    ...
    public final class ClientProviderImpl: AuthProviderClientSupplier {
        ...
        public func client(withRequestClient _: StitchRequestClient, withRoutes _: StitchAuthRoutes, withDispatcher _: OperationDispatcher) -> AnonymousAuthProviderClient {
