...
public protocol StitchUser: CoreStitchUser {
    ...
    /**
     * Links this `StitchUser` with a new identity, where the identity is defined by the credential specified as a parameter.
     * This will only be successful if this `StitchUser` is the currently authenticated `StitchUser` for the client from which
     * it was created.
     *
     * - parameters:
