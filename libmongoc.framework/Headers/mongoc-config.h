...
#define MONGOC_USER_SET_CFLAGS "-arch arm64 -isysroot /Applications/Xcode9.2.0.app/Contents/Developer/Platforms/AppleTVOS.platform/Developer/SDKs/AppleTVOS11.2.sdk -mtvos-version-min=10.2"
