...
class EntityTests: XCTestCase {
    ...
    func testRootEntityUpdateUnset() {
        ...
        student.save().response { response in
            ...
            student.update().response(completionHandler: { _ in
    ...
    func testEmbeddedEntityArrayElementUpdateInitFromDocument() {
        ...
        do {
            ...
            studentFromDocument.save().response { _ in
   ...
   func testEmbeddedEntityArrayUpdateAddRemoveAfterInit() {
    ...
    class TestCollection: MongoDBService.CollectionType {
        ...
        var expectedInputBlock: ((_ document: Document) -> Void)?
