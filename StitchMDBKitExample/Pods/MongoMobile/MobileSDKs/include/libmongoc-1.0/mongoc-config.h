...
#define MONGOC_USER_SET_CFLAGS "-isysroot /Applications/Xcode9.2.0.app/Contents/Developer/Platforms/iPhoneOS.platform/Developer/SDKs/iPhoneOS11.2.sdk -miphoneos-version-min=10.2 -arch arm64"

#define MONGOC_USER_SET_LDFLAGS "-miphoneos-version-min=10.2 -arch arm64 -Wl,-rpath,@loader_path/../lib"

/* MONGOC_CC is used to determine what C compiler was used to compile mongoc */
#define MONGOC_CC "/Applications/Xcode9.2.0.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/bin/clang"
