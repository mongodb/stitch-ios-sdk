...
## Documentation
* [API/Jazzy Documentation](https://s3.amazonaws.com/stitch-sdks/swift/docs/4.0.4/index.html)
...
target '<Your Target Name>' do
    ...
    pod 'StitchSDK/StitchAWSService', '~> 4.0.4'
    # optional: for using the Firebase Cloud Messaging service
    pod 'StitchSDK/StitchFCMService', '~> 4.0.4'
    # optional: for using the HTTP service
    pod 'StitchSDK/StitchHTTPService', '~> 4.0.4'
    # optional: for using the twilio service
    pod 'StitchSDK/StitchTwilioService', '~> 4.0.4'
end
```
