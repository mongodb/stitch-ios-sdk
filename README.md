...
## Documentation
* [API/Jazzy Documentation](https://s3.amazonaws.com/stitch-sdks/swift/docs/4.0.1/index.html)
...
> CocoaPods 1.1.0+ is required to build Stitch iOS 4.0.1+.
...
target '<Your Target Name>' do
    ...
    pod 'StitchSDK/StitchAWSS3Service', '~> 4.0.1'
    # optional: for using the AWS SES service
    pod 'StitchSDK/StitchAWSSESService', '~> 4.0.1'
    # optional: for using the Firebase Cloud Messaging service
    pod 'StitchSDK/StitchFCMService', '~> 4.0.1'
    # optional: for using the HTTP service
    pod 'StitchSDK/StitchHTTPService', '~> 4.0.1'
    # optional: for using the twilio service
    pod 'StitchSDK/StitchTwilioService', '~> 4.0.1'
end
```
