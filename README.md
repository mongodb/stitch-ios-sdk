...
## Documentation
* [API/Jazzy Documentation](https://docs.mongodb.com/stitch-sdks/swift/6.3.0/index.html)
...
target '<Your Target Name>' do
    ...
    pod 'StitchSDK/StitchAWSService', '= 6.3.0'
    # optional: for using the Firebase Cloud Messaging service
    pod 'StitchSDK/StitchFCMService', '= 6.3.0'
    # optional: for using the HTTP service
    pod 'StitchSDK/StitchHTTPService', '= 6.3.0'
    # optional: for using the twilio service
    pod 'StitchSDK/StitchTwilioService', '= 6.3.0'
end
```
