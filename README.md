...
## Documentation
* [API/Jazzy Documentation](https://docs.mongodb.com/stitch-sdks/swift/5.0.0/index.html)
...
target '<Your Target Name>' do
    ...
    pod 'StitchSDK/StitchAWSService', '= 5.0.0'
    # optional: for using the Firebase Cloud Messaging service
    pod 'StitchSDK/StitchFCMService', '= 5.0.0'
    # optional: for using the HTTP service
    pod 'StitchSDK/StitchHTTPService', '= 5.0.0'
    # optional: for using the twilio service
    pod 'StitchSDK/StitchTwilioService', '= 5.0.0'
end
```
