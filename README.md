...
target '<Your Target Name>' do
    ...
    pod 'StitchSDK', '= 5.0.0-alpha.1'

    # optional: for using the AWS service
    pod 'StitchSDK/StitchAWSService', '= 5.0.0-alpha.1'
    # optional: for using the Firebase Cloud Messaging service
    pod 'StitchSDK/StitchFCMService', '= 5.0.0-alpha.1'
    # optional: for using the HTTP service
    pod 'StitchSDK/StitchHTTPService', '= 5.0.0-alpha.1'
    # optional: for using the twilio service
    pod 'StitchSDK/StitchTwilioService', '= 5.0.0-alpha.1'
end
```
